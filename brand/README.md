...
and its sidebar wordmark embeds `logo-full-black.png` byte-identical
(`packages/shell/src/BrandWordmark.tsx`).
...
| `logo-full-black.png` | all-black wordmark | yellow `#FDD238` backgrounds; light product chrome |
