...
consumer adds wins automatically, and no per-app patch is needed. If an
app still carries a local `@layer components { .pr-card { ... } }` patch
from before this was documented, it's safe to delete.
